    ...
    <div className="flex flex-col justify-center">
      ...
      >
        <div className="h-[800vh] w-full max-w-screen-lg relative">
          ...
          >
            <div className={"flex flex-col w-full duration-1000 "+  (pos > 70 ? ' -translate-x-[200vh]' : '')}>
              ...
              <div className="flex flex-row justify-between">
                <div className={"w-[45%]  duration-1000 "+  (pos < 50  ? 'translate-y-[100vh]' : '')}>
                ...
                <div  className={"w-[45%]  duration-1000 "+  (pos < 30 ? 'translate-y-[100vh]' : '')}>
                  <div className="text-neutral-900 text-xl font-semibold font-inter">
                    TUM Bachelor
                    <div className="text-neutral-500 font-normal text-sm">
                      {' '}
          ...
          <div className={"flex flex-row justify-between sticky top-1/2 duration-1000 " +  (pos < 70 ? 'translate-x-[200vh]' : '')}>
